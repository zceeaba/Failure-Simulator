...
class GraphSolve(object):
	...
	def trafficdemandcalc(self,pe_traffic,autotraffic):
	...
	def shortestpath(self,shortest_path,traffic):
	...
	def flowcalc(self,flows,G):
		...
		for demand_key, traffic in flows.items():
			...
			edges = self.shortestpath(shortest_path,traffic)
